...
title = tk.Label(window,text="Student Attendance System ",bd=10,relief=tk.GROOVE,font=("times new roman",40),bg="misty rose",fg="black")
title.pack(side=tk.TOP,fill=tk.X)

Manage_Frame=Frame(window,bg="misty rose")
Manage_Frame.place(x=0,y=80,width=600,height=530)

ttk.Label(window, text = "Year",background="misty rose", foreground ="black",font = ("Times New Roman", 15)).place(x=100,y=150)
...
ttk.Label(window, text = "Branch",background="misty rose", foreground ="black",font = ("Times New Roman", 15)).place(x=100,y=200)
...
ttk.Label(window, text = "Section",background="misty rose", foreground ="black",font = ("Times New Roman", 15)).place(x=100,y=250)
...
ttk.Label(window, text = "Period",background="misty rose", foreground ="black",font = ("Times New Roman", 15)).place(x=100,y=300)
...
Manag_Frame=Frame(window,bg="misty rose")
Manag_Frame.place(x=480,y=80,width=450,height=530)

canvas = Canvas(Manag_Frame, width = 300, height = 300,background="misty rose")      
canvas.pack()      
